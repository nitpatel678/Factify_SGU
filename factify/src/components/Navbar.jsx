...
export default function Navbar() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center p-6 bg-gray-900">
      <h1 id='heading' className="text-3xl font-bold text-white tracking-widest">Factify</h1>
      <nav id='navlinks' className="flex space-x-6">
        ...
        <a href="#contact" className="hover:text-zinc-100 text-white">Contact</a>
      </nav>
    </header>
  );
}
